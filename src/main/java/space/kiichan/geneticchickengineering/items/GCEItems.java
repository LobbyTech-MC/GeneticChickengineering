...
public final class GCEItems {
    ...
    public static final SlimefunItemStack EXCITATION_CHAMBER_2 = new SlimefunItemStack("GCE_EXCITATION_CHAMBER_2", new ItemStack(Material.BLAST_FURNACE), "§e加强版鼓舞室", "§r§7§o鸡产生资源的地方", "§r§7§o速度更快", LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), LoreBuilder.powerPerSecond(15));
    public static final SlimefunItemStack EXCITATION_CHAMBER_10 = new SlimefunItemStack("GCE_EXCITATION_CHAMBER_10", new ItemStack(Material.BLAST_FURNACE), "§e终级鼓舞室", "§r§7§o鸡产生资源的地方", "§r§7§o速度最快", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), LoreBuilder.powerPerSecond(100));
